This is an application that function in order to determine the overall returns of investments over a period of time. To do so, this app uses api's & a monte carlo simulation. 
